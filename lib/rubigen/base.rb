...
module RubiGen
  ...
  #
  # See RubiGen::Base for a discussion of manifests, 
  # RubiGen::Commands::Create for methods available to the manifest,
  # and RubiGen for a general discussion of generators.
    ...
    protected
      ...
      def attributes
        @attributes ||= @args.collect do |attribute|
          RubiGen::GeneratedAttribute.new(*attribute.split(":"))
        end
      end
